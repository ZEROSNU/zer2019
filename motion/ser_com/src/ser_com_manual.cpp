...
#include "core_msgs_019/Control.h"
#include <sstream>
#include <iostream>
#include <cstdio>
#include <cstdlib>
...
int main ( int argc, char **argv )
{
  ...
  ros::init(argc, argv, "ser_com");

  ros::NodeHandle n;

  ros::Publisher pub_cont = n.advertise<core_msgs_019::Control> ("/Control", 1000);

  ros::Rate loop_rate(10);

  int count =0;
  while (ros::ok()) {
    core_msgs_019::Control msg;
