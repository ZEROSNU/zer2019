		...
		if (prevgray.data)
		{
			...
			//-----------------------------计算 F-Matrix
				...
				*/
				...
				//imwrite("/home/kimsangmin/ZERO_VISION/ADAS-moving-object-detection/output/result2_" + a + b, pre_frame);
				//imwrite("/home/kimsangmin/ZERO_VISION/ADAS-moving-object-detection/output/result3_" + a + b, frame);
