...
#mode
# 0:left cam  /  1:front cam  /  3:right cam
mode = 3
cam_set = 0
src_points = [0, 0, 0, 0]
if mode == 0:
...
#for front cam
if cam_str == 'front':
    dest_1 = np.array([370,300-60]) #
    dest_2 = np.array([190,300-60]) # 
    dest_3 = np.array([190,300+60]) #
    dest_4 = np.array([370,300+60]) #

#for left cam
if cam_str == 'left':
    dest_1 = np.array([145+90,300-90-120]) #
    dest_2 = np.array([145,300-90-120]) # 
    dest_3 = np.array([145,300-90]) #
    dest_4 = np.array([145+90,300-90]) #

#for right cam
if cam_str == "right":
    dest_1 = np.array([145+90,300+90]) #
    dest_2 = np.array([145,300+90]) # 
    dest_3 = np.array([145,300+90+120]) #
    dest_4 = np.array([145+90,300+90+120]) #
