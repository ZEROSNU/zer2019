...
def main():
    ...
    pub_map = rospy.Publisher('/local_map', OccupancyGrid, queue_size=10)
    rospy.Subscriber("/initial_pose", PoseWithCovarianceStamped, initCB)
    rospy.Subscriber("/goal_pose", PoseStamped, goalCB)
